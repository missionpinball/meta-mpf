...
CORE_IMAGE_EXTRA_INSTALL += " python python-datetime python-io python-core python-misc python-pygame python-pypinproc python-pyyaml python-imaging packagegroup-core-x11-xserver"
